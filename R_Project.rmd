...
The scatter plot tracks the individual performance of each fencer and group them by their clubs. I used scale_colour_manual as I wanted to colour code the podium winners to highlight fencers who did exceptionally well in the particular competition. When hovered, it provides information of the fencer's Name, Club and Final Ranking using plotly
